...
{
    class SoundboardWrapperContext : ApplicationContext
    {
        private SoundboardManager manager;

        private SoundboardWrapper form;
        ...
        public SoundboardWrapperContext()
        {
            manager = new SoundboardManager();

            if (manager.Setup())
            {
                form = new SoundboardWrapper(manager);
            }
            else
            {
        ...
        private void InitializeComponent()
        {
            ...
            TrayIcon.Text = "SoundboardWrapper";

            TrayIcon.Icon = Properties.Resources.SoundboardWrapper;
            ...
            this.TrayIconContextMenu.Name = "SoundboardWrapper";
            ...
            this.CloseMenuItem.Text = "Close SoundboardWrapper";
        ...
        {
            if (MessageBox.Show("Are you sure you want to close SoundboardWrapper?",
                    "Close SoundboardWrapper?", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation,
